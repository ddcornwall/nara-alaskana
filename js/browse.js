...
function printNumObj(response) {
  ...
  if (typeof response.objects === 'undefined' && recType === "fileUnit") {
    ...
    $("#recent").append("<br> <a href=\"https://catalog.archives.gov/search?q=*:*&f.ancestorNaIds=" + response.naId + "&sort=naIdSort%20asc" + "\" target=\"_blank\" rel=\"noopener\">View digital objects in National Archives Catalog [external link]</a>");
...
function printRecLoc(response) {
  $("#recent").append("<br><a href=\"https://catalog.archives.gov/id/" + response.naId + "\" target=\"_blank\" rel=\"noopener\">View full record in NARA Catalog [external link]</a>");
} //End printRecLoc
